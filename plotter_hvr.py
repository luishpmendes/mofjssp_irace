...
plt.tight_layout()
filename = os.path.join(dirname, "hvr/hvr_mean_per_num_jobs.png")
plt.savefig(bbox_inches='tight', fname=filename, format="png")
filename = os.path.join(dirname, "hvr/hvr_mean_per_num_jobs.pdf")
plt.savefig(bbox_inches='tight', fname=filename, format="pdf")
plt.close()
...
plt.gca().yaxis.set_minor_formatter(FormatStrFormatter('%.2f'))
plt.tight_layout()
filename = os.path.join(dirname, "hvr/hvr_quartiles_per_num_jobs.png")
plt.savefig(bbox_inches='tight', fname=filename, format="png")
filename = os.path.join(dirname, "hvr/hvr_quartiles_per_num_jobs.pdf")
plt.savefig(bbox_inches='tight', fname=filename, format="pdf")
plt.close()
...
plt.gca().yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
plt.tight_layout()
filename = os.path.join(dirname, "hvr/hvr_mean_per_num_machines.png")
plt.savefig(bbox_inches='tight', fname=filename, format="png")
filename = os.path.join(dirname, "hvr/hvr_mean_per_num_machines.pdf")
plt.savefig(bbox_inches='tight', fname=filename, format="pdf")
plt.close()
...
plt.gca().yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
plt.tight_layout()
filename = os.path.join(dirname, "hvr/hvr_quartiles_per_num_machines.png")
plt.savefig(bbox_inches='tight', fname=filename, format="png")
filename = os.path.join(dirname, "hvr/hvr_quartiles_per_num_machines.pdf")
plt.savefig(bbox_inches='tight', fname=filename, format="pdf")
plt.close()
...
plt.gca().yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
plt.tight_layout()
filename = os.path.join(dirname, "hvr/hvr_mean_per_total_num_operations.png")
plt.savefig(bbox_inches='tight', fname=filename, format="png")
filename = os.path.join(dirname, "hvr/hvr_mean_per_total_num_operations.pdf")
plt.savefig(bbox_inches='tight', fname=filename, format="pdf")
plt.close()
...
plt.gca().yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
plt.tight_layout()
filename = os.path.join(dirname, "hvr/hvr_quartiles_per_total_num_operations.png")
plt.savefig(bbox_inches='tight', fname=filename, format="png")
filename = os.path.join(dirname, "hvr/hvr_quartiles_per_total_num_operations.pdf")
plt.savefig(bbox_inches='tight', fname=filename, format="pdf")
plt.close()
