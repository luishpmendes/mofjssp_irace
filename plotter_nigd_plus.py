...
for group in solver_groups:
    ...
    plt.tight_layout()
    filename = os.path.join(dirname, "nigd_plus/nigd_plus_mean_per_num_jobs_" + group + ".png")
    plt.savefig(bbox_inches='tight', fname=filename, format="png")
    filename = os.path.join(dirname, "nigd_plus/nigd_plus_mean_per_num_jobs_" + group + ".pdf")
    plt.savefig(bbox_inches='tight', fname=filename, format="pdf")
    plt.close()
...
for group in solver_groups:
    ...
    plt.tight_layout()
    filename = os.path.join(dirname, "nigd_plus/nigd_plus_quartiles_per_num_jobs_" + group + ".png")
    plt.savefig(bbox_inches='tight', fname=filename, format="png")
    filename = os.path.join(dirname, "nigd_plus/nigd_plus_quartiles_per_num_jobs_" + group + ".pdf")
    plt.savefig(bbox_inches='tight', fname=filename, format="pdf")
    plt.close()
...
for group in solver_groups:
    ...
    plt.legend(fontsize="large", loc="best")
    plt.tight_layout()
    filename = os.path.join(dirname, "nigd_plus/nigd_plus_mean_per_num_machines_" + group + ".png")
    plt.savefig(bbox_inches='tight', fname=filename, format="png")
    filename = os.path.join(dirname, "nigd_plus/nigd_plus_mean_per_num_machines_" + group + ".pdf")
    plt.savefig(bbox_inches='tight', fname=filename, format="pdf")
    plt.close()
...
for group in solver_groups:
    ...
    plt.tight_layout()
    filename = os.path.join(dirname, "nigd_plus/nigd_plus_quartiles_per_num_machines_" + group + ".png")
    plt.savefig(bbox_inches='tight', fname=filename, format="png")
    filename = os.path.join(dirname, "nigd_plus/nigd_plus_quartiles_per_num_machines_" + group + ".pdf")
    plt.savefig(bbox_inches='tight', fname=filename, format="pdf")
    plt.close()
...
for group in solver_groups:
    ...
    plt.legend(fontsize="large", loc="upper left")
    plt.tight_layout()
    filename = os.path.join(dirname, "nigd_plus/nigd_plus_mean_per_total_num_operations_" + group + ".png")
    plt.savefig(bbox_inches='tight', fname=filename, format="png")
    filename = os.path.join(dirname, "nigd_plus/nigd_plus_mean_per_total_num_operations_" + group + ".pdf")
    plt.savefig(bbox_inches='tight', fname=filename, format="pdf")
    plt.close()
...
for group in solver_groups:
    ...
    plt.legend(fontsize="large", loc="upper left")
    plt.tight_layout()
    filename = os.path.join(dirname, "nigd_plus/nigd_plus_quartiles_per_total_num_operations_" + group + ".png")
    plt.savefig(bbox_inches='tight', fname=filename, format="png")
    filename = os.path.join(dirname, "nigd_plus/nigd_plus_quartiles_per_total_num_operations_" + group + ".pdf")
    plt.savefig(bbox_inches='tight', fname=filename, format="pdf")
    plt.close()
